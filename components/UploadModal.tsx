        ...
        {step === 'SELECT' ? (
          <>
            <div className="text-center mb-10">
              <h2 className="text-2xl font-black tracking-tight mb-2 uppercase italic tracking-tighter">ANIX CREAR</h2>
              ...
              {isLargeFile && (
                <div className="bg-orange-500/10 border border-orange-500/20 rounded-2xl p-4 flex items-start space-x-3">
                  ...
                  <p className="text-[11px] text-orange-200/80 leading-relaxed font-medium">
                    ...
                    Este video tardará en subirse debido a su alta calidad. Te recomendamos usar la <span className="text-white font-bold italic underline cursor-pointer" onClick={() => setStep('RECORD')}>Cámara ANIX</span> para subidas instantáneas.
                  </p>
                </div>
              )}
            </div>
